    ...
    utils
      ...
      .then(() => {
        ...
        setTimeout(() => {
          ...
          const id2 = f1
            .overlay()
            .communication.sendBroadcast('2', null, { e: id1.e, c: 3 })
          setTimeout(() => {
    ...
    utils
      ...
      .then(() => {
        ...
        setTimeout(() => {
          const id1 = f1
            .overlay()
            .communication.broadcast._causality.increment()
          const id2 = f1
            .overlay()
            .communication.broadcast._causality.increment()
          ...
          f1.overlay().communication.sendBroadcast('4', null, id2)
          setTimeout(() => {
            f1.overlay().communication.broadcast._sendAll(
              f1
                .overlay()
                .communication.broadcast._createBroadcastMessage('1', id1, null)
            )
            f1.overlay().communication.broadcast._sendAll(
              f1
                .overlay()
                .communication.broadcast._createBroadcastMessage('2', id2, id3)
            )
          }, 2000)
        }, 2000)
      })
