...
export class LinkView {
  ...
  constructor(container, id) {
    ...
    var qrCodeModalDialog = jQuery('<div>')
      .appendTo(qrCodeModal)
      .addClass('modal-dialog')
    var qrCodeModalContent = jQuery('<div>')
      .appendTo(qrCodeModalDialog)
    ...
    var inputGroup2 = jQuery('<span>')
      .appendTo(inputGroup)
      .addClass('input-group-btn')

    this.qrcode = jQuery('<button>')
    ...
    this.action = jQuery('<button  id="copyButton">')
      .appendTo(inputGroup2)
      .attr('aria-label', 'Go!')
      .attr('type', 'button')
      .addClass('btn btn-default')
  ...
  printLaunchLink(link) {
    ...
    this.input.attr(
      'placeholder',
      'A link will appear in this field, give it to your ' + 'friend!'
    )
  ...
  askLaunchLink() {
    ...
    this.input.attr(
      'placeholder',
      'Please, copy the ticket of your friend here to stamp ' + 'it!'
    )
    this.qrcode.hide()
    return this.action
  }
  ...
  askAnswerLink() {
    ...
    this.input.attr(
      'placeholder',
      'Copy the stamped ticket to confirm ' + 'your arrival in the network'
    )
    this.qrcode.hide()
    return this.action
  }
