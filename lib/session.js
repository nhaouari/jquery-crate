...
class session {
  ...
  init() {
    request({
      ...
      this._options.webRTCOptions = (addresses && addresses.ice) || {
        iceServers: [{
  ...
  justDoIt() {
    ...
    // WEBRTC
    var webRTCOptions = (this._options && this._options.webRTCOptions) ||
    ...
    const signalingOptions =merge({
        address: 'https://signaling.herokuapp.com', //this._options.signalingServer,
        session: sessionId
      },
      (this._options && this._options.importFromJSON &&
