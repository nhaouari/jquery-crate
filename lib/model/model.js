...
function Model(options) {
    ...
    //needed options signalingOptions, webRTCOptions, name, importFromJSON
    ...
    this.webRTCOptions = options.webRTCOptions;

    this.core = new Core(this.uid, {
        webrtc: options.webRTCOptions,
        signalingOptions: options.signalingOptions
    });
    this.signaling = new Signaling(this.core.app.overlay().network, options.signalingOptions);
