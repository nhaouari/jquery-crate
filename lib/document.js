  ...
  constructor(options, foglet) {
    ...
    this._foglet.connection()
      .then(() => {
        ...
        this.signaling = new Signaling(this._foglet.overlay().network, options.signalingOptions);
        ...
        this._view = new View(options, this)
        this._foglet.emit('connected')
      })

    window.crate_model = this
    window.GUID2=this.GUID
  }
